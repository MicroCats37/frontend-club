                        ...
                        return (
                            <div className="space-y-10">
                                ...
                                <div className="flex p-2 bg-[#F4F7F4] rounded-[2rem] border border-[#E0E7E0]/40 relative">
                                    ...
                                    >
                                        <Hash className={cn("w-4 h-4", mode === "CIP" ? "text-primary" : "text-[#8BA18B]")} />
                                        INGRESO CIP
                                    </button>
                                    <button
                                        type="button"
                                    ...
                                    >
                                        <CreditCard className={cn("w-4 h-4", mode === "DNI" ? "text-primary" : "text-[#8BA18B]")} />
                                        INGRESO DNI
                                    </button>
                                </div>
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div className="space-y-3">
                                        <Label className="text-[10px] font-black text-[#2C3A2C] uppercase tracking-[0.2em] ml-5">
                                            {mode === "DNI" ? "Documento Nacional de Identidad" : "Número de Colegiatura (CIP)"}
                                        </Label>
                                        <div className="relative group">
                                            ...
                                            <Input
                                                ...
                                                type="text"
                                                inputMode="numeric"
                                                placeholder={mode === "DNI" ? "Ej: 12345678" : "Ej: 123456"}
                                                ...
                                                className={cn(
                                                    ...
                                                    (errors as any)[mode.toLowerCase()] && "border-red-300 focus:ring-red-100 focus:border-red-400"
                                                )}
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex items-center justify-between px-5">
                                            ...
                                            <Link href="/recuperar" className="text-[10px] font-black text-primary hover:text-emerald-700 uppercase tracking-tighter decoration-primary/20 decoration-2 underline underline-offset-4 transition-all">
                                                ¿LA OLVIDASTE?
                                            </Link>
                                        </div>
                                        <div className="relative group">
                                            ...
                                            <Input
                                                ...
                                                className={cn(
                                                    ...
                                                    errors.password && "border-red-300 focus:ring-red-100 focus:border-red-400"
                                                )}
                                                {...register("password")}
                                            />
                                            <button
