        ...
        try {
            ...
            const iziConfig = {
                ...
                order: data.order || {
                    ...
                    dateTimeTransaction: (Date.now() * 1000).toString()
                },
            ...
            const callbackResponsePayment = async (response: any) => {
                ...
                if (response.code === "00") {
                    ...
                    try {
                        ...
                        toast.error("Error de comunicación. Si ya pagaste, recarga la página para ver el cambio.", {
                            duration: 8000
                        });
            ...
            toast.error(`Error: ${error.message || "No se pudo conectar con la pasarela"}`);
            onClose();
        } finally {
            setLoading(false);
        }
